...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('locator_station', 'local_range', self.gf('django.contrib.gis.db.models.fields.GeometryField')(default=''), keep_default=False)

        # Adding field 'Station.distant_range'
        db.add_column('locator_station', 'distant_range', self.gf('django.contrib.gis.db.models.fields.PolygonField')(default=''), keep_default=False)

        # Adding field 'Station.fringe_range'
        db.add_column('locator_station', 'fringe_range', self.gf('django.contrib.gis.db.models.fields.PolygonField')(default=''), keep_default=False)
    ...
    models = {
        'locator.station': {
            ...
            'local_range': ('django.contrib.gis.db.models.fields.GeometryField', [], {}),
